...
4. Ensure column data types so that numerical values are stored as integer or double; month is stored as date.   I had to make sure the csv file saved numbers without commas.   I have stored off column data types in Describe Output.csv
6. Run the SQL Files 
